(() => {
  ...
  // frappe-html:/home/frappe-user/frappe-bench/apps/erpnext/erpnext/public/js/templates/visual_plant_floor_template.html
...
`;
        ...
        if (data && data.apply_rule_on_other_items && JSON.parse(data.apply_rule_on_other_items)) {
          me.frm.doc.items.forEach((d) => {
            if (in_list(JSON.parse(data.apply_rule_on_other_items), d[data.apply_rule_on]) && d.item_code === data.item_code) {
              for (var k2 in data) {
                if (data.pricing_rule_for == "Discount Percentage" && data.apply_rule_on_other_items && k2 == "discount_amount") {
                  continue;
                }
  ...
  // frappe-html:/home/frappe-user/frappe-bench/apps/erpnext/erpnext/public/js/templates/item_selector.html
...
`;
  ...
  // frappe-html:/home/frappe-user/frappe-bench/apps/erpnext/erpnext/public/js/templates/item_quick_entry.html
...
`;
  ...
  // frappe-html:/home/frappe-user/frappe-bench/apps/erpnext/erpnext/public/js/templates/call_link.html
...
`;
  ...
  // frappe-html:/home/frappe-user/frappe-bench/apps/erpnext/erpnext/public/js/templates/crm_activities.html
...
.form-footer {
  ...
  // frappe-html:/home/frappe-user/frappe-bench/apps/erpnext/erpnext/public/js/templates/crm_notes.html
...
//# sourceMappingURL=erpnext.bundle.KFLNDXAC.js.map
